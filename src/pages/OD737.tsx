...
import InsertMetricForm from "../components/InsertMetricForm"; // adjust path if different
...
export default function OD737Page(): JSX.Element {
  ...
  async function fetchMetrics(month?: string) {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/737_metrics.php${q}`);
  ...
  async function handleDelete(id?: number) {
    ...
    try {
      const res = await fetch(`${API_BASE}/delete_metric_737.php`, {
        method: "DELETE",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12, padding: 20, flex: 1, minHeight: 0 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <h1 style={{ margin: 0 }}>Flight 737 - Planned Roaster</h1>
        </div>
